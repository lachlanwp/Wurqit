...
describe("Cross-Platform Compatibility", () => {
  ...
  describe("Windows Compatibility", () => {
    ...
    test("should create Windows file paths", () => {
      ...
      expect(fullPath).toBe(
        "C:\\Users\\TestUser\\Desktop\\workout_video_2025-01-15T10-30-00-000Z.mp4"
      );
    });
    ...
    test("should handle Windows path normalization", () => {
      const normalizedPath = path.win32.normalize(
        "C:\\Users\\TestUser\\..\\TestUser\\Desktop"
      );
      expect(normalizedPath).toBe("C:\\Users\\TestUser\\Desktop");
    });

    test("should handle Windows path resolution", () => {
      const resolvedPath = path.win32.resolve(
        "C:\\Users",
        "TestUser",
        "Desktop"
      );
    ...
    test("should handle Windows path parsing", () => {
      const parsedPath = path.win32.parse(
        "C:\\Users\\TestUser\\Desktop\\file.txt"
      );
  ...
  describe("macOS Compatibility", () => {
    ...
    test("should create macOS file paths", () => {
      ...
      expect(fullPath).toBe(
        "/Users/testuser/Desktop/workout_video_2025-01-15T10-30-00-000Z.mp4"
      );
    });

    test("should handle macOS path normalization", () => {
      const normalizedPath = path.posix.normalize(
        "/Users/testuser/../testuser/Desktop"
      );
  ...
  describe("Linux Compatibility", () => {
    ...
    test("should create Linux file paths", () => {
      ...
      expect(fullPath).toBe(
        "/home/testuser/Desktop/workout_video_2025-01-15T10-30-00-000Z.mp4"
      );
    });

    test("should handle Linux path normalization", () => {
      const normalizedPath = path.posix.normalize(
        "/home/testuser/../testuser/Desktop"
      );
  ...
  describe("Path Separator Handling", () => {
    ...
    test("should handle path joining with absolute paths", () => {
      const absolutePath = path.isAbsolute("/home/user")
        ? "/home/user"
        : "C:\\Users\\User";
